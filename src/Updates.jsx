 ...
 <p className="flex items-center gap-3 text-slate-400 leading-relaxed mb-4">
  ...
  { name: "June", year: "2026", content: <div className="text-slate-500 pt-1">
    ...
    <div className = "translate-y-3">
      <p className="text-slate-400 leading-relaxed mb-4">
          <span className="inline-block w-2 h-2 bg-white rounded-full mr-3 mb-[2px]"></span>
          June 26th, 2026: We will implement a more refined version of the design idea we had back on May 24th. We think the hollow cylinder wll fully detach and reattach to the rover after data is collected using something similar to a hook mechanism. We have also updated and completed our budget plan for rover equipment.
</p>
