        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
            ...
            <div className="md:col-span-7 space-y-4">
              ...
              <p className="flex items-center gap-3 text-slate-400 leading-relaxed">
            Idea #1: Use Heteroscedastic Gaussian Process Regression (HGPR) to quantify uncertainty. This way, the variance at any point on the map will also take into consideration the actual values of those points. For example, consider two pairs of points: pair 1 has points A and B, 10 feet from each other, and pair 2 has points X and Y, also 10 feet from each other. Now, say the moisture at points A and B is 10%, while in pair 2, the moisture at X is 10% and the moisture at Y is 50%. Kriging variance assumes uncertainty between points A and B is the same as that between X and Y, since they are the same distance from each other; it only considers the geometry and spatial information to calculate uncertainty. HGPR solves this exact problem by combining information from two models: one to predict moisture and the second to predict variance.
            </p>
              <p className="flex items-center gap-3 text-slate-400 leading-relaxed">
               Idea #2: Have the drone create a path to samples at points it thinks will contribute the most information to the heatmap model, while also flying the shortest distance to minimize battery usage. This could be achieved by calculating an acquisition function with a travel cost penalty to sample the most optimal areas as it flies through the field.
              </p>
            </div>
